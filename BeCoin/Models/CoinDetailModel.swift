...
/*
 ...
 
 {
   ...
   "sentiment_votes_up_percentage": 82.27,
   "sentiment_votes_down_percentage": 17.73,
   "watchlist_portfolio_users": 1334742,
   "market_cap_rank": 1,
   "coingecko_rank": 1,
   ...
   "status_updates": [],
   "last_updated": "2023-08-30T18:31:21.554Z"
 }
...
struct CoinDetailModel: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case blockTimeInMinutes = "blockTimeInMinutes"
        case hashingAlgorithm = "hashing_algorithm"
    }
    
    var readableDescription: String? {
        return description?.en?.removingHTMLOccurrances
    }
}
